...
Rail-dbGaP secures an EMR cluster so it is compliant with NIH guidelines as follows. (See Figure 1 of the [preprint](http://j.mp/rail-dbgap) for an illustration. The sections [Set up Amazon Web Services](README.md#setup) and [K-mer counting dbGaP-protected data with EMR](README.md#kmer) put together protocol elements to show their implementation explicitly.)
